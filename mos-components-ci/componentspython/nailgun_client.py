...
from componentshttp import HTTPClient
from componentshttp import json_parse
from componentshttp import logger
from componentshttp import logwrap
...
class NailgunClient(object):
    ...
    @logwrap
    def save_diagnostic_snapshot(self, snapshot_url, file_name):
        with open(file_name, 'w') as f:
            f.write(self.client.get(snapshot_url).read())
